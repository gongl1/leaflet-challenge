...
// Create overlay object to hold the overlay layer, corresponds to two big layerGroups on line 5
var overlayMaps = {
...
// helper function for markerSize and chooseColor below 
d3.json(earthquakesURL, function(earthquakeData) {
  ...
  L.geoJSON(earthquakeData, {
    ...
    onEachFeature: function(feature, layer) {
      ...
      + new Date(feature.properties.time) + "</p><hr><p>Magnitude: " + feature.properties.mag + "</p>" + "</p><hr><p>Depth: " + feature.geometry.coordinates[2] + "</p>");
    }
  }).addTo(earthquakes);
